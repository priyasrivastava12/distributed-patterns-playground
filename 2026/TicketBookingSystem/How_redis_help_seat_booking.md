...
can u let me know the structure of redis data and how it is used for preventing lock condition and also what is the role of DB I want flow diagram and proper explanation with example and also I want to know if more than 100 user try to book at the same time how concurrency is dealt
